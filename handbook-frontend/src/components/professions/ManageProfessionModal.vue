    ...
    <div class="modal-overlay">
        <div class="modal">
            ...
            <div class="modal-body">
                <form @submit.prevent="$emit('update', profession)">
                    <label>
                        Наименование:
                    ...
                    <label>
                        Примечание:
                        <input type="text" v-model="profession.note" />
                    </label>
                    <div class="modal-actions">
                        <button type="submit" class="save-button">Сохранить</button>
                        <button @click.prevent="$emit('delete', profession)" class="delete-button">Удалить</button>
                    </div>
                </form>
            </div>
        </div>
